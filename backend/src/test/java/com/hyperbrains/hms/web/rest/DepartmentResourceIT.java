...
import com.hyperbrains.hms.service.mapper.DepartmentMapper;
...
class DepartmentResourceIT {
    ...
    public static Department createEntity() {
        return new Department().name(DEFAULT_NAME).code(DEFAULT_CODE).active(DEFAULT_ACTIVE);
    }
    ...
    public static Department createUpdatedEntity() {
        return new Department().name(UPDATED_NAME).code(UPDATED_CODE).active(UPDATED_ACTIVE);
    }
    ...
    void putExistingDepartment() throws Exception {
        ...
        updatedDepartment.name(UPDATED_NAME).code(UPDATED_CODE).active(UPDATED_ACTIVE);
    ...
    void partialUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).code(UPDATED_CODE);
    ...
    void fullUpdateDepartmentWithPatch() throws Exception {
        ...
        partialUpdatedDepartment.name(UPDATED_NAME).code(UPDATED_CODE).active(UPDATED_ACTIVE);
