...
@WithMockUser(authorities = AuthoritiesConstants.RECEPTION)
class AppointmentResourceIT {
    ...
    private static final LocalDate UPDATED_SCHEDULED_DATE = LocalDate.parse("2026-09-24");

    private static final LocalTime DEFAULT_SCHEDULED_TIME = LocalTime.NOON;
    private static final LocalTime UPDATED_SCHEDULED_TIME = LocalTime.MAX.withNano(0);

    private static final String DEFAULT_REASON = "AAAAAAAAAA";
    private static final String UPDATED_REASON = "BBBBBBBBBB";

    private static final AppointmentStatus DEFAULT_STATUS = AppointmentStatus.SCHEDULED;
    private static final AppointmentStatus UPDATED_STATUS = AppointmentStatus.CHECKED_IN;
    ...
    void checkScheduledTimeIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        appointment.setScheduledTime(null);
    ...
    void getAllAppointments() throws Exception {
        ...
        restAppointmentMockMvc
            ...
            .andExpect(jsonPath("$.[*].scheduledTime").value(hasItem(DEFAULT_SCHEDULED_TIME.format(LOCAL_DATE_TIME_FORMAT))))
    ...
    void getAppointment() throws Exception {
        ...
        restAppointmentMockMvc
            ...
            .andExpect(jsonPath("$.scheduledTime").value(DEFAULT_SCHEDULED_TIME.format(LOCAL_DATE_TIME_FORMAT)))
    ...
    void partialUpdateAppointmentWithPatch() throws Exception {
        ...
        partialUpdatedAppointment.scheduledDate(UPDATED_SCHEDULED_DATE).status(UPDATED_STATUS);
