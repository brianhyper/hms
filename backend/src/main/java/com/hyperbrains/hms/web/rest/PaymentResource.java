...
/**
 * REST controller for managing {@link com.hyperbrains.hms.domain.Payment}.
 */
@RestController
...
public class PaymentResource {
    ...
    public ResponseEntity<List<PaymentDTO>> getAllPayments(
        ...
        if ("bill-is-null".equals(filter)) {
            LOG.debug("REST request to get all Payments where bill is null");
            return new ResponseEntity<>(paymentService.findAllWhereBillIsNull(), HttpStatus.OK);
        }
