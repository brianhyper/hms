...
/**
 * Service Interface for managing {@link com.hyperbrains.hms.domain.Payment}.
 */
public interface PaymentService {
    ...
    /**
     * Get all the PaymentDTO where Bill is {@code null}.
     *
     * @return the {@link List} of entities.
     */
    List<PaymentDTO> findAllWhereBillIsNull();
