...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BILLLINEITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BILLLINEITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BILLLINEITEM actions', async () => {
      const arg = { id: 17788 };
    ...
    it('dispatches UPDATE_BILLLINEITEM actions', async () => {
      const arg = { id: 17788 };
    ...
    it('dispatches PARTIAL_UPDATE_BILLLINEITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BILLLINEITEM actions', async () => {
      const arg = 42666;
