...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONSULTATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONSULTATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONSULTATION actions', async () => {
      const arg = { id: 21194 };
    ...
    it('dispatches UPDATE_CONSULTATION actions', async () => {
      const arg = { id: 21194 };
    ...
    it('dispatches PARTIAL_UPDATE_CONSULTATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONSULTATION actions', async () => {
      const arg = 42666;
