...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './result.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESULT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESULT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESULT actions', async () => {
      const arg = { id: 31302 };
    ...
    it('dispatches UPDATE_RESULT actions', async () => {
      const arg = { id: 31302 };
    ...
    it('dispatches PARTIAL_UPDATE_RESULT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESULT actions', async () => {
      const arg = 42666;
