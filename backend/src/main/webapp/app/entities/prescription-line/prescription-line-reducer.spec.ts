...
import reducer, {
  ...
  reset,
  updateEntity,
} from './prescription-line.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRESCRIPTIONLINE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRESCRIPTIONLINE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRESCRIPTIONLINE actions', async () => {
      const arg = { id: 16493 };
    ...
    it('dispatches UPDATE_PRESCRIPTIONLINE actions', async () => {
      const arg = { id: 16493 };
    ...
    it('dispatches PARTIAL_UPDATE_PRESCRIPTIONLINE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRESCRIPTIONLINE actions', async () => {
      const arg = 42666;
