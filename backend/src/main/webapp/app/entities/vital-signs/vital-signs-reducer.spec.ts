...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VITALSIGNS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VITALSIGNS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VITALSIGNS actions', async () => {
      const arg = { id: 4698 };
    ...
    it('dispatches UPDATE_VITALSIGNS actions', async () => {
      const arg = { id: 4698 };
    ...
    it('dispatches PARTIAL_UPDATE_VITALSIGNS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VITALSIGNS actions', async () => {
      const arg = 42666;
