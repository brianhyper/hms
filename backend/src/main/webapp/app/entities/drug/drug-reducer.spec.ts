...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './drug.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DRUG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DRUG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DRUG actions', async () => {
      const arg = { id: 10252 };
    ...
    it('dispatches UPDATE_DRUG actions', async () => {
      const arg = { id: 10252 };
    ...
    it('dispatches PARTIAL_UPDATE_DRUG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DRUG actions', async () => {
      const arg = 42666;
