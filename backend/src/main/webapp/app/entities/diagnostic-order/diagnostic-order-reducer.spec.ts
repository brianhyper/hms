...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIAGNOSTICORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIAGNOSTICORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIAGNOSTICORDER actions', async () => {
      const arg = { id: 23655 };
    ...
    it('dispatches UPDATE_DIAGNOSTICORDER actions', async () => {
      const arg = { id: 23655 };
    ...
    it('dispatches PARTIAL_UPDATE_DIAGNOSTICORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DIAGNOSTICORDER actions', async () => {
      const arg = 42666;
