...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RADIOLOGYEXAM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RADIOLOGYEXAM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RADIOLOGYEXAM actions', async () => {
      const arg = { id: 17969 };
    ...
    it('dispatches UPDATE_RADIOLOGYEXAM actions', async () => {
      const arg = { id: 17969 };
    ...
    it('dispatches PARTIAL_UPDATE_RADIOLOGYEXAM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RADIOLOGYEXAM actions', async () => {
      const arg = 42666;
