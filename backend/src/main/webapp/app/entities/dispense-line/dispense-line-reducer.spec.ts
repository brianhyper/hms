...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPENSELINE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISPENSELINE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISPENSELINE actions', async () => {
      const arg = { id: 4522 };
    ...
    it('dispatches UPDATE_DISPENSELINE actions', async () => {
      const arg = { id: 4522 };
    ...
    it('dispatches PARTIAL_UPDATE_DISPENSELINE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISPENSELINE actions', async () => {
      const arg = 42666;
