...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './dispense.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISPENSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISPENSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISPENSE actions', async () => {
      const arg = { id: 10554 };
    ...
    it('dispatches UPDATE_DISPENSE actions', async () => {
      const arg = { id: 10554 };
    ...
    it('dispatches PARTIAL_UPDATE_DISPENSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISPENSE actions', async () => {
      const arg = 42666;
