...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './referral.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REFERRAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REFERRAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REFERRAL actions', async () => {
      const arg = { id: 10687 };
    ...
    it('dispatches UPDATE_REFERRAL actions', async () => {
      const arg = { id: 10687 };
    ...
    it('dispatches PARTIAL_UPDATE_REFERRAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REFERRAL actions', async () => {
      const arg = 42666;
