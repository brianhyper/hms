...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_APPOINTMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_APPOINTMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_APPOINTMENT actions', async () => {
      const arg = { id: 584 };
    ...
    it('dispatches UPDATE_APPOINTMENT actions', async () => {
      const arg = { id: 584 };
    ...
    it('dispatches PARTIAL_UPDATE_APPOINTMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_APPOINTMENT actions', async () => {
      const arg = 42666;
