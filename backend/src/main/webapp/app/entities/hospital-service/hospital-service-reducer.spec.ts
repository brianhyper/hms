...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HOSPITALSERVICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_HOSPITALSERVICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_HOSPITALSERVICE actions', async () => {
      const arg = { id: 1619 };
    ...
    it('dispatches UPDATE_HOSPITALSERVICE actions', async () => {
      const arg = { id: 1619 };
    ...
    it('dispatches PARTIAL_UPDATE_HOSPITALSERVICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_HOSPITALSERVICE actions', async () => {
      const arg = 42666;
