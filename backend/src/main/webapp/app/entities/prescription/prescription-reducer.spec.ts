...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRESCRIPTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRESCRIPTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRESCRIPTION actions', async () => {
      const arg = { id: 9334 };
    ...
    it('dispatches UPDATE_PRESCRIPTION actions', async () => {
      const arg = { id: 9334 };
    ...
    it('dispatches PARTIAL_UPDATE_PRESCRIPTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRESCRIPTION actions', async () => {
      const arg = 42666;
