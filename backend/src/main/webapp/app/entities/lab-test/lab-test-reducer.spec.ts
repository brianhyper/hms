...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './lab-test.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LABTEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LABTEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LABTEST actions', async () => {
      const arg = { id: 27203 };
    ...
    it('dispatches UPDATE_LABTEST actions', async () => {
      const arg = { id: 27203 };
    ...
    it('dispatches PARTIAL_UPDATE_LABTEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LABTEST actions', async () => {
      const arg = 42666;
