...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './diagnosis.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIAGNOSIS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIAGNOSIS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIAGNOSIS actions', async () => {
      const arg = { id: 12044 };
    ...
    it('dispatches UPDATE_DIAGNOSIS actions', async () => {
      const arg = { id: 12044 };
    ...
    it('dispatches PARTIAL_UPDATE_DIAGNOSIS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DIAGNOSIS actions', async () => {
      const arg = 42666;
